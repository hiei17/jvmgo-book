...
public interface AttributeInfo {
    static AttributeInfo[] readAttributes(BytecodeReader reader, ConstantPool cp) {
    ...
    static AttributeInfo readAttribute(BytecodeReader reader, ConstantPool cp) {
    ...
    AttributeInfo readInfo(BytecodeReader reader);
