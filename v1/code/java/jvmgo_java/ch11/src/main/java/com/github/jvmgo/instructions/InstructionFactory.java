...
import com.github.jvmgo.instructions.control.Return;
...
public class InstructionFactory {
    ...
    private static Instruction Xaload = new XAload();//数组 stack.push(stack.pop2[stack.pop1])
    ...
    private static Instruction land = new MathOperator(DateTypeEnum.l,OperatorEnum.and);
    private static Instruction ior = new MathOperator(DateTypeEnum.i,OperatorEnum.or);
    private static Instruction lor = new MathOperator(DateTypeEnum.l,OperatorEnum.or);
    private static Instruction ixor = new MathOperator(DateTypeEnum.i,OperatorEnum.xor);
    private static Instruction lxor = new MathOperator(DateTypeEnum.l,OperatorEnum.xor);
    ...
    private static Instruction ireturn=new Return(1);
    private static Instruction lreturn=new Return(2);
    private static Instruction freturn=new Return(1);
    private static Instruction dreturn=new Return(2);
    private static Instruction areturn=new Return(1);
    private static Instruction _return=new Return(0);
    private static Instruction arraylength=new Arraylength();
    private static Instruction invoke_native=new InvokeNative();
    ...
    public static Instruction newInstruction(int opcode) {
        switch (opcode) {
           ...
           //方法返回
            ...
            case 0xbc:
                return new Newarray();//new int[]
            case 0xbd:
                return new ANewarray();//new String[]
            case 0xbe:
                return arraylength   ;
