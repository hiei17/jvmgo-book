...
public class Field extends ClassMember {
    ...
    private Field(MemberInfo memberInfo, CClass clazz) {

        super(memberInfo,clazz);//field method只有属性不同
    }


    public static   Field[] newFields(CClass jvmClass, MemberInfo[] memberInfos) {
